...
PREFIX_DIR=darshan-3.1.3

DARSHAN_HOME="$(dirname $(readlink -f ${BASH_SOURCE[0]}))"
...
function build_edison() {
    ...
    DARSHAN_RUNTIME_CONFIG_FLAGS="--enable-HDF5-pre-1.10 --with-log-path-by-env=DARSHAN_LOGPATH,SLURM_SUBMIT_DIR,PWD --disable-cuserid --with-mem-align=8 --with-jobid-env=SLURM_JOBID --enable-mmap-logs CC=cc"
    DARSHAN_UTIL_CONFIG_FLAGS="--with-zlib --with-bzlib CC=cc"
